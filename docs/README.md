...
Start here for project operations:

- `../GATEKEEPER.md` — authoritative provenance and promotion policy.
- `GATEKEEPER_QUICKSTART.md` — shortest owner/external workflow.
- `PROJECT_WORKFLOW.md` — end-to-end Tlaloc/Origami -> Tonal propagation.
